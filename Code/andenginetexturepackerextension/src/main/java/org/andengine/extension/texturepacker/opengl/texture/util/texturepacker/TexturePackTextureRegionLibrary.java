...
public class TexturePackTextureRegionLibrary
{
	...
	public ITiledTextureRegion get(final String pSource, int columns, int rows)
	{
		TexturePackerTextureRegion localTexturePackTextureRegion = (TexturePackerTextureRegion) this.mSourceMapping
				.get(pSource);
	...
	private void throwOnCollision(final TexturePackerTextureRegion pTexturePackTextureRegion)
