 ...
 */
public class SideBorderLeft extends BaseGameElement<Sprite> {
    public static final String ID = "SideBorderLeft";
    public static final float HEIGHT = 1000;

    private IGameSceneServices _gameSceneServices;

    public SideBorderLeft(PhysicsWorld physicsWorld, IGameSceneServices gameSceneServices) {
        super(physicsWorld);
